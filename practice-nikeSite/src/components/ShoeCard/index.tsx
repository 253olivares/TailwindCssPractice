...
const index = ({imgURL, changeBigShoeImage, bigShoeImg}: 
    {
        imgURL:
  ...
  return (
    ...
    onClick={handleClick}
    >
        <div className='flex justing-center items-center bg-card bg-center bg-cover sm:w-40 sm:h-40 rounded-xl max-sm:p-4'>
